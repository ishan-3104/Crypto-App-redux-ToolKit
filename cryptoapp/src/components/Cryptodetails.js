...
export default function Cryptodetails() {
  ...
  const { id } = useParams();
  const{data ,isFatching}= useGetCryptoDetailsQuery(id)
    ...
    <div>
      <Col className="coin-detail-container">
        <Col className="coin-heading-container">
          ...
          <p>
            {cryptoDetails?.name} live Price in Us Doller View value Statistic,
        ...
        <Col className="stats-container">
          <Col className="coin-value-statistic">
            <Col className="coin-value-statistic-heading">
              ...
              <p>An Overviwe showing the statistic {cryptoDetails?.name}</p>
            </Col>
          ...
          <Col className="other-stat-info">
            <Col className="coin-value-statistic-heading">
              ...
              <p>An Overviwe showing the statistic of all Cryptocurrences</p>
            </Col>
